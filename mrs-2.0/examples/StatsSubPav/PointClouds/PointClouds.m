...
% for output from PointClouds example two histograms
% shows 2 d range with height
%

clear all

funcName = 'PointClouds';
...
Oneboxestitle = 'Carved SEB PQ adaptive Hist';
boxesFileName = 'adhFirstBigBurst_t0.3.txt';
...
Twoboxestitle = 'Carved SEB PQ adaptive Hist';

boxesFileName = 'adhFirstBigBurst.txt';;
