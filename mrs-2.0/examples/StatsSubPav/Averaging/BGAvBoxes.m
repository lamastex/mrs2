...
% for output from Bivariate Gaussian example average
...
boxestitle = ['Average Histogram for', ' ', funcName, ' and PDF'];
color_edge = [.5 .5 .5];    % edge colour 
figure(1);
