...
% for output from Levy example for separate histograms
...
Oneboxestitle = 'Sample 1';

boxesFileName = 'Hist1.txt';
...
OneZ1 = Onebase;
OneZ2 = dataR(:,2)./dataR(:,2); % height as count_in_box/volume
...
Twoboxestitle = 'Sample 2';

boxesFileName = 'Hist2.txt';
...
Threeboxestitle = 'Sample 3';

boxesFileName = 'Hist3.txt';
...
Fourboxestitle = 'Sample 4';

boxesFileName = 'Hist4.txt';
...
Fiveboxestitle = 'Sample 5';

boxesFileName = 'Hist5.txt';
...
Sixboxestitle = 'Sample 6';

boxesFileName = 'Hist6.txt';
...
Sevenboxestitle = 'Sample 7';

boxesFileName = 'Hist7.txt';
...
Eightboxestitle = 'Sample 8';

boxesFileName = 'Hist8.txt';
...
Nineboxestitle = 'Sample 9';

boxesFileName = 'Hist9.txt';
...
Tenboxestitle = 'Sample 10';

boxesFileName = 'Hist10.txt';
