% txt file importing
% for output from Example 3.4

[aX1 aX2 aY1 aY2] = textread('AIA3_4a.txt', '%*s %f %*s %f %*s %*s %*s %f %*s %f %*s', 'headerlines', 3);
[bX1 bX2 bY1 bY2] = textread('AIA3_4b.txt', '%*s %f %*s %f %*s %*s %*s %f %*s %f %*s', 'headerlines', 3);
[cX1 cX2 cY1 cY2] = textread('AIA3_4c.txt', '%*s %f %*s %f %*s %*s %*s %f %*s %f %*s', 'headerlines', 3);
