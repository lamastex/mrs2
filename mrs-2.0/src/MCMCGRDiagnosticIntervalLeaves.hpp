...
using leaves as the scalar value and interval method for diagnostic.
 */

#ifndef __MCMCGRAUTO_DIAG_INTERVAL_LEAVES_HPP__
#define __MCMCGRAUTO_DIAG_INTERVAL_LEAVES_HPP__

#include "MCMCGRDiagnosticInterval.hpp"

namespace subpavings {
	
	class MCMCGRDiagnosticIntervalLeaves : public MCMCGRDiagnosticInterval {
		...
		public:
			...
			MCMCGRDiagnosticIntervalLeaves(cxsc::real t,
											size_t si,
											double percent,
											bool req = false);
			...
			~MCMCGRDiagnosticIntervalLeaves();
		...
		private:
			...
			MCMCGRDiagnosticIntervalLeaves(const MCMCGRDiagnosticIntervalLeaves& other);
			
			MCMCGRDiagnosticIntervalLeaves operator=(const MCMCGRDiagnosticIntervalLeaves& rhs);
			MCMCGRDiagnosticIntervalLeaves operator=(MCMCGRDiagnosticIntervalLeaves rhs);
