...
using logposterior as the scalar value.
 */

#ifndef __MCMCGRAUTO_DIAG_PSRF_LOGPOST_HPP__
#define __MCMCGRAUTO_DIAG_PSRF_LOGPOST_HPP__

#include "MCMCGRDiagnosticPSRF.hpp"

namespace subpavings {
	
	class MCMCGRDiagnosticPSRFLogpost : public MCMCGRDiagnosticPSRF {
		...
		public:
			...
			\pre t > 0.0.*/
			explicit MCMCGRDiagnosticPSRFLogpost(cxsc::real t,
												bool req = false);
			
			~MCMCGRDiagnosticPSRFLogpost();
		...
		private:
			...
			MCMCGRDiagnosticPSRFLogpost(const MCMCGRDiagnosticPSRFLogpost& other);
			
			MCMCGRDiagnosticPSRFLogpost operator=(const MCMCGRDiagnosticPSRFLogpost& rhs);
			MCMCGRDiagnosticPSRFLogpost operator=(MCMCGRDiagnosticPSRFLogpost rhs);
