...
using average depth as the scalar value and interval method for diagnostic.
 */

#ifndef __MCMCGRAUTO_DIAG_INTERVAL_AVDEPTH_HPP__
#define __MCMCGRAUTO_DIAG_INTERVAL_AVDEPTH_HPP__

#include "MCMCGRDiagnosticInterval.hpp"

namespace subpavings {
	
	class MCMCGRDiagnosticIntervalAvDepth : public MCMCGRDiagnosticInterval {
		...
		public:
			...
			MCMCGRDiagnosticIntervalAvDepth(cxsc::real t,
											size_t si,
											double percent,
											bool req = false);
			...
			~MCMCGRDiagnosticIntervalAvDepth();
		...
		private:
			...
			MCMCGRDiagnosticIntervalAvDepth(const MCMCGRDiagnosticIntervalAvDepth& other);
			
			MCMCGRDiagnosticIntervalAvDepth operator=(const MCMCGRDiagnosticIntervalAvDepth& rhs);
			MCMCGRDiagnosticIntervalAvDepth operator=(MCMCGRDiagnosticIntervalAvDepth rhs);
