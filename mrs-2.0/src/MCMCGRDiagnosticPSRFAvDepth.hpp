...
#ifndef __MCMCGRAUTO_DIAG_PSRF_AVDEPTH_HPP__
#define __MCMCGRAUTO_DIAG_PSRF_AVDEPTH_HPP__

#include "MCMCGRDiagnosticPSRF.hpp"

namespace subpavings {
	
	class MCMCGRDiagnosticPSRFAvDepth : public MCMCGRDiagnosticPSRF {
		...
		public:
			...
			\pre t > 0.0.*/
			explicit MCMCGRDiagnosticPSRFAvDepth(cxsc::real t,
												bool req = false);
			
			~MCMCGRDiagnosticPSRFAvDepth();
		...
		private:
			...
			MCMCGRDiagnosticPSRFAvDepth(const MCMCGRDiagnosticPSRFAvDepth& other);
			
			MCMCGRDiagnosticPSRFAvDepth operator=(const MCMCGRDiagnosticPSRFAvDepth& rhs);
			MCMCGRDiagnosticPSRFAvDepth operator=(MCMCGRDiagnosticPSRFAvDepth rhs);
