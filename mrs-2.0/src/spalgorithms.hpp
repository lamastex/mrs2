...
/*! \file
\brief SPMinimalnode (MinimalSubPaving) algorithm function declarations
...
namespace subpavings {
    ...
    */
    ...
    /*! \brief Evaluates images of subpaving.
    ...
    */
    ...
    which now uses public member functions in the SPMinimalnode class.
    ...
    */
    ...
    image of, the SPMinimal passed to BoolTest.
    ...
    */
    SPMinimalnode* Sivia (PIBT BoolTest, const SPMinimalnode * const toInvert,
    ...
    \param spn the minimal subpaving for which we wish to find a subpaving
    ...
    */
    ...
    subpaving under some function f.
    */
    SPMinimalnode* ImageSpNonMinimal(PIVF f, SPMinimalnode *spn, double eps);
