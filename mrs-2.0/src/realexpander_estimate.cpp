...
/*! \file
\brief definitions for RealExpanderEstimator
...
namespace subpavings {
    ...
    RealExpanderEstimator::RealExpanderEstimator(const MappedFobj& f, cxsc::real tol)
	...
	RealExpanderEstimator::~RealExpanderEstimator() {}


    cxsc::real RealExpanderEstimator::visit(SPnode * spn) const
    {
		#ifdef MYDEBUG
