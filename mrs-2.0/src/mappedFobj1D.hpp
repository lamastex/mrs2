...
#ifndef __MAPPEDFOBJ1D__
#define __MAPPEDFOBJ1D__
...
/*! \brief An abstract class for target function objects on 1-dimensional real space

*/

namespace subpavings {

    class MappedFobj1D : public MappedFobj {
        ...
        public:
            ...
            virtual cxsc::interval operator()(const cxsc::interval&) const = 0;
            ...
            virtual cxsc::real operator()(const cxsc::real&) const = 0;
            ...
            virtual cxsc::real imageMid(const cxsc::interval&) const;

            //! Destructor
            virtual ~MappedFobj1D(){}
