...
/*! \file
\brief MappedFobj9D definitions.
*/
...
cxsc::interval MappedFobj9D::operator()(const cxsc::ivector& ivec) const
{
...
cxsc::real MappedFobj9D::operator()(const cxsc::rvector& rv) const
{
	return this->operator()(
		rv[1],
		rv[2],
...
cxsc::real MappedFobj9D::imageMid(const cxsc::ivector& ivec) const
{
	return this->operator()(
		cxsc::mid(ivec[1]),
		cxsc::mid(ivec[2]),
...
cxsc::real MappedFobj9D::imageMid(
