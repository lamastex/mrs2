...
/*! \file 
\brief MappedFobj9D declarations.
*/

#ifndef __MAPPEDFOBJ9D__
#define __MAPPEDFOBJ9D__
...
namespace subpavings {
	...
	*/
    ...
    class MappedFobj9D : public MappedFobj{
        ...
        public:
            ...
            virtual cxsc::real imageMid( 
					...
					const cxsc::interval&, const cxsc::interval&,
					const cxsc::interval&, const cxsc::interval&, 
					const cxsc::interval&) const;

            //! Destructor
            virtual ~MappedFobj9D(){}
