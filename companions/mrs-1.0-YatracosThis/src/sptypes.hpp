...
namespace subpavings {
    ...
    */
    ...
    If a logging level > 1 is specified by the user but is not supported by the
    method, a level of TXT will be used.
    */
    ...
    */
    ...
    ivector in a subpaving.  The inclusion function is specified in the
    ...
    */
    typedef IntVec::iterator Size_tVecItr;
    ...
    */
    ...
    /*! \brief Define type SPSVnodePtrs as container of pointers to SPSVnodes
    */
    typedef std::vector<SPSVnode*> SPSVnodePtrs;

    /*! \brief Define type SPSVnodePtrsItr as an iterator over SPSVnodePtrs
    */
    typedef SPSVnodePtrs::iterator SPSVnodePtrsItr ;
