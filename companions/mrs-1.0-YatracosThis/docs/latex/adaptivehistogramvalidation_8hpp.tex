\hypertarget{adaptivehistogramvalidation_8hpp}{\subsection{adaptivehistogramvalidation.\-hpp \-File \-Reference}
\label{adaptivehistogramvalidation_8hpp}\index{adaptivehistogramvalidation.\-hpp@{adaptivehistogramvalidation.\-hpp}}
}


\-Adaptive\-Histogram\-Validation declarations.  


{\ttfamily \#include \char`\"{}spsvnode.\-hpp\char`\"{}}\*
{\ttfamily \#include \char`\"{}splitdecisionobj.\-hpp\char`\"{}}\*
{\ttfamily \#include \char`\"{}nodecompobjval.\-hpp\char`\"{}}\*
...
\item 
class \hyperlink{classsubpavings_1_1AdaptiveHistogramValidation}{subpavings\-::\-Adaptive\-Histogram\-Validation}
\begin{DoxyCompactList}\small\item\em \-A wrapper or manager for an \hyperlink{classsubpavings_1_1SPSVnode}{\-S\-P\-S\-Vnode} aka \-Stats\-Sub\-Paving\-Val in conjunction with massive amounts of sample data. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\begin{DoxyCompactItemize}
\item 
std\-::ostream \& \hyperlink{adaptivehistogramvalidation_8hpp_a98003f456bdd16c0db0f055e76ad48ee}{operator$<$$<$} (std\-::ostream \&os, const \hyperlink{classsubpavings_1_1AdaptiveHistogramValidation}{subpavings\-::\-Adaptive\-Histogram\-Validation} \&adh)
...
size\-\_\-t \hyperlink{adaptivehistogramvalidation_8hpp_a93dfc6a08f529c2082c7ffcf6a5225c8}{check\-Num\-Valley} (std\-::vector$<$ double $>$ vec\-Max\-Delta, std\-::vector$<$ int $>$ \&valley\-Hist\-Pos, bool \&plateau, int \&current\-Smallest)
\item 
void \hyperlink{adaptivehistogramvalidation_8hpp_a08484be3202c86d9a369d04b1a1c7e1e}{get\-Current\-Yat\-Class} (std\-::vector$<$ std\-::set$<$ \hyperlink{classsubpavings_1_1CollatorSPVnode}{\-Collator\-S\-P\-Vnode} $\ast$, std\-::less$<$ \hyperlink{classsubpavings_1_1CollatorSPVnode}{\-Collator\-S\-P\-Vnode} $\ast$ $>$ $>$ $>$ \&vec\-Row\-Yat\-Set, std\-::vector$<$ std\-::set$<$ \hyperlink{classsubpavings_1_1CollatorSPVnode}{\-Collator\-S\-P\-Vnode} $\ast$, std\-::less$<$ \hyperlink{classsubpavings_1_1CollatorSPVnode}{\-Collator\-S\-P\-Vnode} $\ast$ $>$ $>$ $>$ \&vec\-Col\-Yat\-Set, std\-::list$<$ std\-::set$<$ \hyperlink{classsubpavings_1_1CollatorSPVnode}{\-Collator\-S\-P\-Vnode} $\ast$, std\-::less$<$ \hyperlink{classsubpavings_1_1CollatorSPVnode}{\-Collator\-S\-P\-Vnode} $\ast$ $>$ $>$ $>$ \&list\-Yat\-Set)
\item 
cxsc\-::interval \hyperlink{adaptivehistogramvalidation_8hpp_a34c69f3d97096d5aaf88958a1449963b}{get\-Fin\-Mix\-Interval\-True\-Delta} (\hyperlink{structFinMix}{\-Fin\-Mix} \&mixt, double tol, int deg, std\-::set$<$ \hyperlink{classsubpavings_1_1CollatorSPVnode}{\-Collator\-S\-P\-Vnode} $\ast$, less$<$ \hyperlink{classsubpavings_1_1CollatorSPVnode}{\-Collator\-S\-P\-Vnode} $\ast$ $>$ $>$ \&\-Yat\-Set)
\item 
cxsc\-::real \hyperlink{adaptivehistogramvalidation_8hpp_a9a9e088604995104a0313e525d4771e7}{get\-Unif\-True\-Delta} (\hyperlink{classsubpavings_1_1AdaptiveHistogram}{\-Adaptive\-Histogram} \&my\-Part, double weight, vector$<$ int $>$ holes\-Loc, std\-::set$<$ \hyperlink{classsubpavings_1_1CollatorSPVnode}{\-Collator\-S\-P\-Vnode} $\ast$, less$<$ \hyperlink{classsubpavings_1_1CollatorSPVnode}{\-Collator\-S\-P\-Vnode} $\ast$ $>$ $>$ \&\-Yat\-Set)
\item 
cxsc\-::real \hyperlink{adaptivehistogramvalidation_8hpp_a918a753fde4f86110c4fd1f958ae29b1}{get\-Mapped\-Function\-True\-Delta} (\hyperlink{classsubpavings_1_1RealMappedSPnode}{\-Real\-Mapped\-S\-Pnode} \&node\-Est\-Hist, std\-::set$<$ \hyperlink{classsubpavings_1_1CollatorSPVnode}{\-Collator\-S\-P\-Vnode} $\ast$, less$<$ \hyperlink{classsubpavings_1_1CollatorSPVnode}{\-Collator\-S\-P\-Vnode} $\ast$ $>$ $>$ \&\-Yat\-Set)
...
\-Definition in file \hyperlink{adaptivehistogramvalidation_8hpp_source}{adaptivehistogramvalidation.\-hpp}.



\subsubsection{\-Function \-Documentation}
\hypertarget{adaptivehistogramvalidation_8hpp_a93dfc6a08f529c2082c7ffcf6a5225c8}{\index{adaptivehistogramvalidation.\-hpp@{adaptivehistogramvalidation.\-hpp}!check\-Num\-Valley@{check\-Num\-Valley}}
\index{check\-Num\-Valley@{check\-Num\-Valley}!adaptivehistogramvalidation.hpp@{adaptivehistogramvalidation.\-hpp}}
\paragraph[{check\-Num\-Valley}]{\setlength{\rightskip}{0pt plus 5cm}size\-\_\-t {\bf check\-Num\-Valley} (
\begin{DoxyParamCaption}
\item[{std\-::vector$<$ double $>$}]{vec\-Max\-Delta, }
\item[{std\-::vector$<$ int $>$ \&}]{valley\-Hist\-Pos, }
\item[{bool \&}]{plateau, }
\item[{int \&}]{current\-Smallest}
\end{DoxyParamCaption}
)}}\label{adaptivehistogramvalidation_8hpp_a93dfc6a08f529c2082c7ffcf6a5225c8}
...
\end{DoxyCode}
\hypertarget{adaptivehistogramvalidation_8hpp_a08484be3202c86d9a369d04b1a1c7e1e}{\index{adaptivehistogramvalidation.\-hpp@{adaptivehistogramvalidation.\-hpp}!get\-Current\-Yat\-Class@{get\-Current\-Yat\-Class}}
\index{get\-Current\-Yat\-Class@{get\-Current\-Yat\-Class}!adaptivehistogramvalidation.hpp@{adaptivehistogramvalidation.\-hpp}}
...
\end{DoxyParamCaption}
)}}\label{adaptivehistogramvalidation_8hpp_a08484be3202c86d9a369d04b1a1c7e1e}
\hypertarget{adaptivehistogramvalidation_8hpp_a34c69f3d97096d5aaf88958a1449963b}{\index{adaptivehistogramvalidation.\-hpp@{adaptivehistogramvalidation.\-hpp}!get\-Fin\-Mix\-Interval\-True\-Delta@{get\-Fin\-Mix\-Interval\-True\-Delta}}
\index{get\-Fin\-Mix\-Interval\-True\-Delta@{get\-Fin\-Mix\-Interval\-True\-Delta}!adaptivehistogramvalidation.hpp@{adaptivehistogramvalidation.\-hpp}}
...
\end{DoxyParamCaption}
)}}\label{adaptivehistogramvalidation_8hpp_a34c69f3d97096d5aaf88958a1449963b}
...
\end{DoxyCode}
\hypertarget{adaptivehistogramvalidation_8hpp_a918a753fde4f86110c4fd1f958ae29b1}{\index{adaptivehistogramvalidation.\-hpp@{adaptivehistogramvalidation.\-hpp}!get\-Mapped\-Function\-True\-Delta@{get\-Mapped\-Function\-True\-Delta}}
\index{get\-Mapped\-Function\-True\-Delta@{get\-Mapped\-Function\-True\-Delta}!adaptivehistogramvalidation.hpp@{adaptivehistogramvalidation.\-hpp}}
\paragraph[{get\-Mapped\-Function\-True\-Delta}]{\setlength{\rightskip}{0pt plus 5cm}cxsc\-::real {\bf get\-Mapped\-Function\-True\-Delta} (
\begin{DoxyParamCaption}
\item[{{\bf \-Real\-Mapped\-S\-Pnode} \&}]{node\-Est\-Hist, }
\item[{std\-::set$<$ {\bf \-Collator\-S\-P\-Vnode} $\ast$, less$<$ {\bf \-Collator\-S\-P\-Vnode} $\ast$ $>$ $>$ \&}]{\-Yat\-Set}
\end{DoxyParamCaption}
)}}\label{adaptivehistogramvalidation_8hpp_a918a753fde4f86110c4fd1f958ae29b1}
...
\end{DoxyCode}
\hypertarget{adaptivehistogramvalidation_8hpp_a9a9e088604995104a0313e525d4771e7}{\index{adaptivehistogramvalidation.\-hpp@{adaptivehistogramvalidation.\-hpp}!get\-Unif\-True\-Delta@{get\-Unif\-True\-Delta}}
\index{get\-Unif\-True\-Delta@{get\-Unif\-True\-Delta}!adaptivehistogramvalidation.hpp@{adaptivehistogramvalidation.\-hpp}}
...
\item[{std\-::set$<$ {\bf \-Collator\-S\-P\-Vnode} $\ast$, less$<$ {\bf \-Collator\-S\-P\-Vnode} $\ast$ $>$ $>$ \&}]{\-Yat\-Set}
\end{DoxyParamCaption}
)}}\label{adaptivehistogramvalidation_8hpp_a9a9e088604995104a0313e525d4771e7}
\-Get the true delta for a finite gaussian mixture distribution. 
...
\end{DoxyCode}
\hypertarget{adaptivehistogramvalidation_8hpp_a98003f456bdd16c0db0f055e76ad48ee}{\index{adaptivehistogramvalidation.\-hpp@{adaptivehistogramvalidation.\-hpp}!operator$<$$<$@{operator$<$$<$}}
\index{operator$<$$<$@{operator$<$$<$}!adaptivehistogramvalidation.hpp@{adaptivehistogramvalidation.\-hpp}}
...
\end{DoxyParamCaption}
)}}\label{adaptivehistogramvalidation_8hpp_a98003f456bdd16c0db0f055e76ad48ee}
