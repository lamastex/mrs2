\hypertarget{Coverage_8cpp}{\subsection{\-Coverage.\-cpp \-File \-Reference}
\label{Coverage_8cpp}\index{\-Coverage.\-cpp@{\-Coverage.\-cpp}}
}
...
\item 
dotprecision \hyperlink{Coverage_8cpp_aa761d6c65ae1def2134f8829dd6be8fd}{get\-Unif\-I\-A\-E} (vector$<$ double $>$, vector$<$ double $>$)
\item 
int \hyperlink{Coverage_8cpp_a3c04138a5bfe5d72780bb7e82a18e627}{main} (int argc, char $\ast$$\ast$argv)
\end{DoxyCompactItemize}


\subsubsection{\-Function \-Documentation}
\hypertarget{Coverage_8cpp_aa761d6c65ae1def2134f8829dd6be8fd}{\index{\-Coverage.\-cpp@{\-Coverage.\-cpp}!get\-Unif\-I\-A\-E@{get\-Unif\-I\-A\-E}}
\index{get\-Unif\-I\-A\-E@{get\-Unif\-I\-A\-E}!Coverage.cpp@{\-Coverage.\-cpp}}
...
)\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}\label{Coverage_8cpp_aa761d6c65ae1def2134f8829dd6be8fd}


\-Definition at line 329 of file \-Coverage.\-cpp.
...
int nLeaves = vol.size();
cout << "There are " << nLeaves << " leaf boxes in this subpaving." << endl;

  for (int k=0; k < nLeaves; k++){
//    cout << "calculating IAE for box " << k << endl;
    if ((1- fhat[k]) < 0.0){
    real r= vol[k]*(fhat[k]-1);
    accumulate(UnifIAE, r, 1.0);
    }

    else if ((1- fhat[k]) > 0.0){
...
\end{DoxyCode}
\hypertarget{Coverage_8cpp_a3c04138a5bfe5d72780bb7e82a18e627}{\index{\-Coverage.\-cpp@{\-Coverage.\-cpp}!main@{main}}
\index{main@{main}!Coverage.cpp@{\-Coverage.\-cpp}}
\paragraph[{main}]{\setlength{\rightskip}{0pt plus 5cm}int {\bf main} (
\begin{DoxyParamCaption}
\item[{int}]{argc, }
\item[{char $\ast$$\ast$}]{argv}
\end{DoxyParamCaption}
)}}\label{Coverage_8cpp_a3c04138a5bfe5d72780bb7e82a18e627}


\-Definition at line 51 of file \-Coverage.\-cpp.
     ...
     if (successfulPQSplit) {
      ...
      // container is filled by reading leaves off tree from left to right
          ...
          // remember that it points to a pointer, so *it is still a ptr
               ...
               //calculate \mu_n - \mu
               diffMu += fabs((*it)->nodeVolume() - ((*it)->getCounter()*1.0/(n
      *1.0)));
//              double diffMu=fabs((*it)->nodeVolume() -
