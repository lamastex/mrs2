...
#ifndef __UNIFORMFOBJ_HPP__
#define __UNIFORMFOBJ_HPP__
...
namespace subpavings {
	...
	class UniformFobj : public subpavings::MappedFobj {

		public:
		
			//! constructor
			UniformFobj(const cxsc::ivector& ivec);
