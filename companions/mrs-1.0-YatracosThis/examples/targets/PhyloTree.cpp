...
// Jukes Cantor formula for transition from nucleotype 
...
// transition probability, from j to i, under CFN model 
// (2 characters in character space)
// conforms to typedef for *RealTranProb_FctPtr
// CFN formula for transition from nucleotype i to j // t is branchlength
// returns a real
...
RealProbs& PhyloTree::fillProbRealJC69(const rvector& x, 
...
// and applying JC69 transition probabilities
IntervalProbs& PhyloTree::fillProbIntervalJC69(const ivector& x, 
                                               const vector<int>& pattern, 
...
// and applying JC69 transition probabilities
HessProbs& PhyloTree::fillProbHessJC69(const HTvector& x, 
                                       const vector<int>& pattern, 
...
RealProbs& PhyloTree::fillProbRealCFN(const rvector& x, 
                                      const vector<int>& pattern, 
                                      RealProbs& rNucProb) const
{
