...
//    int data[][2] = { {1, 2}, {4, 5} };
    ...
    BOOST_CHECK_EQUAL(2, v1.numberOfRows());
    BOOST_CHECK_EQUAL(2, v1.numberOfColumns());
...
//    int data[][2] = { {1, 2}, {4, 5} };
  ...
  }
  {
    ...
    BOOST_CHECK_EQUAL(2, v1.numberOfRows());
    BOOST_CHECK_EQUAL(1, v1.numberOfColumns());
    BOOST_CHECK_EQUAL(1, v1[0][0]);
    BOOST_CHECK_EQUAL(4, v1[1][0]);
  }
...
{
  {
    ...
    BOOST_CHECK_EQUAL(2, A2.numberOfRows());
    BOOST_CHECK_EQUAL(3, A2.numberOfColumns());
...
//    std::cout << A << "\n" << B << "\n=========\n";
    B = std::move(A); 
    BOOST_CHECK_EQUAL(2, B.numberOfRows());
    BOOST_CHECK_EQUAL(3, B.numberOfColumns());
    ...
    BOOST_CHECK_EQUAL(2, A.numberOfRows());
    BOOST_CHECK_EQUAL(2, A.numberOfColumns());
